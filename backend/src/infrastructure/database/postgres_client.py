...
class PostgresClient:
    ...
    async def init_schema(self) -> None:
        ...
        CREATE INDEX IF NOT EXISTS idx_chat_feedback_session ON chat_message_feedback(session_id, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_chat_feedback_agent ON chat_message_feedback(agent_id, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_chat_session_events_session_created ON chat_session_events(session_id, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_chat_session_events_session_room ON chat_session_events(session_id, room_id, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_chat_session_events_session_type ON chat_session_events(session_id, event_type, created_at DESC);
